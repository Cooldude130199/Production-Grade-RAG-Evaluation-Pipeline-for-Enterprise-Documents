...
- 🤗 Hugging Face Transformers — reranker (`ms-marco-MiniLM-L-12-v2`)
- 🔎 Sentence Transformers — embeddings for query/document similarity
- 📄 JSON — storage for index, ground truth, and retrieved results
- 💻 Conda Environment — CPU‑only setup for cost control
- ⚡ CI/CD Pipelines — automated evaluation and resource cleanup via GitHub Actions/Azure DevOps
...
![Pipeline Flow Diagram](https://github.com/Cooldude130199/Production-Grade-RAG-Evaluation-Pipeline-for-Enterprise-Documents/blob/main/assets/Flow%20Diagram.png)
...
![Evaluation Results](https://github.com/Cooldude130199/Production-Grade-RAG-Evaluation-Pipeline-for-Enterprise-Documents/blob/main/assets/Evaluation%20Results.png)
